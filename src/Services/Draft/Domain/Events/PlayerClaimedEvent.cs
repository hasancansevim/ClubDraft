...
public class PlayerClaimedEvent : IDomainEvent
{
    ...
    public PlayerClaimedEvent(Guid pickAttemptId, Guid draftSessionId, Guid clubId, Guid playerId, int pickNumber, string name, PlayerPosition position, int overall, int age, decimal marketValue)
    {
